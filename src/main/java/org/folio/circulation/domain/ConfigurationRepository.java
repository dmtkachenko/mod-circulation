...
public class ConfigurationRepository {
   ...
   *
   */
  public CompletableFuture<Result<LoanHistoryTenantConfiguration>> loanHistoryConfiguration() {
  ...
  private LoanHistoryTenantConfiguration getFistConfiguration(Collection<Configuration> configurations) {
